...
def generate_secret(private_key, public_key):
    ...
    key = hashlib.sha256(secret_bytes).hexdigest()
    return key
# Set the desired key length (e.g., 256 bits)
desired_key_length = 50


# Generate a private key of the desired length
private_key = generate_private_key(desired_key_length)

# Print the generated private key
print("Generated Private Key:", private_key)
pk = generate_public_key(private_key)
print("Generated Public  Key:", pk)