...
def main():
    ...
    #-------------------------Public Key-------------------------
    publicKeyOfReciever = Label(EncryptStep, text="Public-Key of receiver:")
    ...
    #-------------------------Private Key------------------------
    privateKeyOfReciever = Label(DecryptStep, text="Private-Key of receiver:")
    ...
    padding.grid(row=3)
    text2 = Label(Aboutus, text="Created by: ")
    text2.grid(row=4, sticky='S')
    hardiksocial = Label(Aboutus, text="Ajay Saini")
    hardiksocial.bind("<Button-1>", openhardiklinkedin)
    hardiksocial.grid(row=5,  padx=8)
